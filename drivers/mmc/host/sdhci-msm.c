...
static int vitual_cd_value = 0;
int sdhci_msm_get_vitual_cd_pin_value(void)
{
	return vitual_cd_value;
}
EXPORT_SYMBOL_GPL(sdhci_msm_get_vitual_cd_pin_value);
...
void sdhci_msm_card_detect(int slot, unsigned long delay, bool present)
{
	...
	vitual_cd_value = present;
	mmc_detect_change(mmc, delay);
}
EXPORT_SYMBOL_GPL(sdhci_msm_card_detect);
