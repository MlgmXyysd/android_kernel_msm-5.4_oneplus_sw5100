...
#define SWD_IOCTL_DAP_RW        _IOWR('D', 10, unsigned int [2])
#define SWD_IOCTL_PIN_ON        _IO('D', 11)
#define SWD_IOCTL_PIN_OFF        _IO('D', 12)
#define SWD_IOCTL_POWER_OFF_MCU  _IO('D', 13)
#define SWD_IOCTL_HALT_FROZEN    _IO('D', 14)
