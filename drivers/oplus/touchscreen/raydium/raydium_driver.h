...
#define RAD_MINOR_VERSION	0x03
#define RAD_CUSTOMER_VERSION	0x0101
...
extern ssize_t self_test_result_read_from_buffer(char *p_string, ssize_t len);
#endif
