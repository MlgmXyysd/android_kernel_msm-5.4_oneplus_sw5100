...
static int fts_get_fw_file_via_request_firmware(struct fts_upgrade *upg)
{
    ...
    if (oplus_panel_id == 0x108003) {
        snprintf(fwname, FILE_NAME_LENGTH, "focaltech_ts_fw_xh908.bin");
    } else if (oplus_panel_id == 0x097007) {
        snprintf(fwname, FILE_NAME_LENGTH, "focaltech_ts_fw_xh906.bin");
    } else {
        snprintf(fwname, FILE_NAME_LENGTH, "focaltech_ts_fw_xg908.bin");
    }
