...
#define ZINITIX_FW_FILENAME_V1 "zinitix_fw_095001.bin"
#define ZINITIX_FW_FILENAME_V2 "zinitix_fw_095002.bin"

#define ZINITIX_PANEL_ID_V1 0x095001
#define ZINITIX_PANEL_ID_V2 0x095002
...
/* ESD Protection */
#define ZTX_ESD_ENABLE
#define ZTX_CHECK_ESD_TIMER         (5*1000)
#define ZTX_ESD_REG_ADDR            0x001C
#define ZTX_ESD_REG_VALUE           0x5A49

#define ZTX_DEBUG_LOG_MIN           0
#define ZTX_DEBUG_LOG_LOCATION      1
#define ZTX_DEBUG_LOG_COORD_INFO    2
#define ZTX_DEBUG_LOG_MAX           4
