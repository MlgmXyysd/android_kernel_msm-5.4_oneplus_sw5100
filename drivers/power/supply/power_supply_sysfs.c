...
static struct power_supply_attr power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(CHG_LIMIT),
	POWER_SUPPLY_ATTR(SET_CHG_CURRENT),
	POWER_SUPPLY_ATTR(DEMO_MODE),
	POWER_SUPPLY_ATTR(CHARGING_ENABLED),
	POWER_SUPPLY_ATTR(USB_CURRENT),
	POWER_SUPPLY_ATTR(SOC_MCU),
	POWER_SUPPLY_ATTR(AGING_CHG_CTL),
	POWER_SUPPLY_ATTR(REAL_BATTID),
