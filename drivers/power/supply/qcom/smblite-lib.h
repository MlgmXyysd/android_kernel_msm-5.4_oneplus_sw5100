...
/* ultra-low voltage */
#define UPPER_LIMIT_OF_ULTRA_LOW_VOLTAGE_UV	3360000
#define LOWER_LIMIT_OF_ULTRA_LOW_VOLTAGE_UV	3260000
#define ULTRA_LOW_VOL_STEP				200000
...
struct smb_charger {
	...
	int 		pulse_cnt;
	int 		chg_limit;//current 150, if chg_current_limit = 0
