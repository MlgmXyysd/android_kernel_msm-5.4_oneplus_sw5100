...
bool opti_uevt_v = false;		//for vol
bool opti_uevt_t = false;		//for temp
bool pre_opti_uevt = false;		//the pre condition for opti healthd
	...
	if (likely(psy->changed)) {
		...
		if (!strcmp(psy->desc->name,"battery"))
		{
			...
			if (charger_log_enable)
				pr_info("batt KOBJ_CHANGE\n");
		}
		if((!strcmp(psy->desc->name,"usb")) ||(!strcmp(psy->desc->name,"bms")) \
			|| !pre_opti_uevt || !opti_uevt_v || !opti_uevt_t)
