...
#define AW8624_VBAT_MIN				3400
#define AW8624_VBAT_MAX				4400
/*
* aw8624 dts info
*
...
struct aw8624 {
	...
	int gain;
	int f0_value;
	unsigned long long mt_midas_duration;
	unsigned int mt_midas_count;
	...
	unsigned int lra_calib_data; //osc calib data
	unsigned int delay;
	unsigned int loop_cnt;
	unsigned int f0_calib_data;    //f0 calib data
	unsigned int f0_data;   	 //motor real f0
