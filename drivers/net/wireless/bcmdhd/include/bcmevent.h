...
#define WLC_E_REASON_REASSOC		19	/* roamed due to reassoc iovar (only for legacy device) */
#define WLC_E_REASON_SIGNAL_DROP_STEP_POINT					19
#define WLC_E_REASON_HIGH_QBSS_LOAD							20
#define WLC_E_REASON_CUSTOMER_INITIALIZE					21
#define WLC_E_REASON_PARTIAL_SWITCH_FULL					22
#define WLC_E_REASON_LOW_RSSI_PARTIAL2FULL					23
#define WLC_E_REASON_BEACON_LOST_PARTIAL2FULL				24
#define WLC_E_REASON_SIGNAL_DROP_STEP_POINT_PARTIAL2FULL	25
#define WLC_E_REASON_LAST		26	/* NOTE: increment this as you add reasons above */
