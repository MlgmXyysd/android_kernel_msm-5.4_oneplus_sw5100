...
dhd_conf_discard_pkt_filter(dhd_pub_t *dhd)
{
	...
	dhd->pktfilter_count++;
	dhd->pktfilter[dhd->pktfilter_count] = "122 0 0 12 0xFFFF000000000000000000FF000000000000000000000000FFFF 0x08000000000000000000001100000000000000000000000014E9";
	dhd->pktfilter_count++;
...
#ifdef TPUT_MONITOR
		wl_tput_monitor_set_timer(dhd, conf->tput_monitor_ms);
#endif /* TPUT_MONITOR */
	}
