...
#define	DHD_STATIC_VERSION_STR		"101.10.361.11 (wlan=r892223-20210823-1)"
...
EXPORT_SYMBOL_GPL(dhd_wlan_mem_prealloc);
...
static int g_kernel_set_cmdline = 0;
...
int dhd_get_mem_sleep_current(void)
{
	return mem_sleep_current;
}
EXPORT_SYMBOL_NS(dhd_get_mem_sleep_current, BCM_WLAN_EXPORT_ONLY);
#endif

EXPORT_SYMBOL_NS(dhd_get_factory_mac, BCM_WLAN_EXPORT_ONLY);
__setup("bcmmac=", dhd_mac_addr_setup);
