...
#Add for HIGH_TEMP_AGING_TEST build
ifeq (${BUILD_HIGH_TEMP_AGING},true)
KBUILD_CFLAGS += -DHIGH_TEMP_AGING_TEST
endif

ifneq ($(TARGET_BUILD_VARIANT),user)
KBUILD_CFLAGS += -DBUILD_TEST
else
ifeq ($(TARGET_BUILD_TEST),true)
KBUILD_CFLAGS += -DBUILD_TEST
KBUILD_CFLAGS += -DBUILD_USER_TEST
endif
endif
